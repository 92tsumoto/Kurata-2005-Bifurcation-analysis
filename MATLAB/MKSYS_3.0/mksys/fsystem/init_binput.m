...
if iosave==0
	...
	if bf_type ~= 4 
		[l,m,kmax,au,nnn,adj_step,reverse_sw]=textread('bf.in','%d %d %d %f %d %d %d',1,'headerlines',9,'commentstyle','c++','delimiter',',','whitespace',' ');
	else
		[tmp_mu]=textread('bf.in','%f',1,'headerlines',9,'commentstyle','c++','delimiter',',','whitespace',' ');
		[l,m,kmax,au,nnn,adj_step,reverse_sw]=textread('bf.in','%d %d %d %f %d %d %d',1,'headerlines',10,'commentstyle','c++','delimiter',',','whitespace',' ');
	end
...
elseif iosave==1
	...
	if bf_type ~= 4 
		...
		[l,m,kmax,au,nnn,adj_step,reverse_sw]=textread('bf.in','%d %d %d %f %d %d %d',1,'headerlines',11,'commentstyle','c++','delimiter',',','whitespace',' ');
	end
