...
% then the swithch iosave should be 1.
	...
	if iosave==0
		sname='emptyfile';
		[gmax,emax,epsx,feps,reltol,abstol,solsw,ipx,ipy,dipx,endipx,dipy,endipy,l,m,kmax,nnn,istopbf,seigtol]=...
			textread('fix.in','%f %f %f %f %f %f %d %d %d %f %f %f %f %d %d %d %d %d %f',1,'headerlines',2,'commentstyle','c++','delimiter',',','whitespace',' ');

	elseif iosave==1
		[sname]=textread('fix.in','%s',1,'headerlines',2,'commentstyle','c++','delimiter', ',','whitespace',' ');
		[gmax,emax,epsx,feps,reltol,abstol,solsw,ipx,ipy,dipx,endipx,dipy,endipy,l,m,kmax,nnn,istopbf,seigtol]=...
			textread('fix.in','%f %f %f %f %f %f %d %d %d %f %f %f %f %d %d %d %d %d %f',1,'headerlines',3,'commentstyle','c++','delimiter',',','whitespace',' ');
	end
