...
global mu N
	...
	%
		...
		switch s_ind
			...
			case 3 % the function msysvar returned a error value.
				fprintf('Now, the calculation is terminated.\n');
				fprintf('This is because an error value from the function is returned.\n');
	...
	%
		...
		switch s_ind
			case 2 % Divergence
				fprintf('States are divergent.\n');
			case 3 % the function returned a error value.
				fprintf('Now, the calculation is terminated.\n');
				fprintf('This is because an error value from the function is returned.\n');
			case 4 % the Jacobian matrix became a singular matrix.
				fprintf('Now, the calculation is terminated.\n');
	...
	elseif reverse_sw == 0
		...
		switch s_ind
			case 2 % Divergence
				fprintf('States are divergent.\n');
			case 3 % the function is returned a error value.
				fprintf('Now, the calculation is terminated.\n');
				fprintf('This is because an error value from the function is returned.\n');
			case 4 % the Jacobian matrix became a singular matrix.
				fprintf('Now, the calculation is terminated.\n');
