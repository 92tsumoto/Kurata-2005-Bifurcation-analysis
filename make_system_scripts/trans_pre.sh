...
sed -i".org" -e "s/(var.uni + inak.c2\*exp(-var.FRT\*inak.c5\*x\[0\]) + inak.c3\*exp(-var.FRT\*var.uni\*x\[0\]))\^2/(var.uni + inak.c2\*exp(-var.FRT\*inak.c5\*x\[0\]) + inak.c3\*exp(-var.FRT\*var.uni\*x\[0\]))\*(var.uni + inak.c2\*exp(-var.FRT\*inak.c5\*x\[0\]) + inak.c3\*exp(-var.FRT\*var.uni\*x\[0\]))/g" test.txt
...
sed -i".org" -e "s/(var.uni + (var.conccm\*var.kdcm)\/((var.kdcm + x\[12\])\*(var.kdcm + x\[12\])))\^2/(var.uni + (var.conccm\*var.kdcm)\/((var.kdcm + x\[12\])\*(var.kdcm + x\[12\])))\*(var.uni + (var.conccm\*var.kdcm)\/((var.kdcm + x\[12\])\*(var.kdcm + x\[12\])))/g" test.txt
sed -i".org" -e "s/(var.kdcq + x\[13\])\^3/(var.kdcq + x\[13\])\*(var.kdcq + x\[13\])\*(var.kdcq + x\[13\])/g" test.txt
sed -i".org" -e "s/(var.uni + (var.conccq\*var.kdcq)\/((var.kdcq + x\[13\])\*(var.kdcq + x\[13\])))\^2/(var.uni + (var.conccq\*var.kdcq)\/((var.kdcq + x\[13\])\*(var.kdcq + x\[13\])))\*(var.uni + (var.conccq\*var.kdcq)\/((var.kdcq + x\[13\])\*(var.kdcq + x\[13\])))/g" test.txt
